...
- 프로세스 종료: kill -9 [프로세스 ID] 명령어로 해당 프로세스를 강제 종료합니다. <br><br><br>
   2-2. 새 cmd로 접속해서 .pem,.jar파일 aws로 옮기기: scp -i "C:\Users\사용자이름\Downloads\sems-project1-key2.pem" "C:\Users\사용자이름\intelij-workspace\SEMS_Project_6\backend\build\libs\backend-0.0.1-SNAPSHOT.jar" ubuntu@34.231.96.8:/home/ubuntu/
